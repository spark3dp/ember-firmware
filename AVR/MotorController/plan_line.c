...
// JL: not needed for straight line moves static float _get_junction_vmax(const float a_unit[], const float b_unit[]);
 ...
 */
/* JL: not needed as all moves are straight lines
