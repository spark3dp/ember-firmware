...
${OBJECTDIR}/_ext/56246743/I2C_Device.o: ../../C++/I2C_Device.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/I2C_Device.o ../../C++/I2C_Device.cpp

${OBJECTDIR}/_ext/56246743/Logger.o: ../../C++/Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/Logger.o ../../C++/Logger.cpp

${OBJECTDIR}/_ext/56246743/Motor.o: ../../C++/Motor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/Motor.o ../../C++/Motor.cpp

${OBJECTDIR}/_ext/56246743/MotorCommand.o: ../../C++/MotorCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/MotorCommand.o ../../C++/MotorCommand.cpp

${OBJECTDIR}/_ext/56246743/PrinterStatus.o: ../../C++/PrinterStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/PrinterStatus.o ../../C++/PrinterStatus.cpp

${OBJECTDIR}/_ext/56246743/Settings.o: ../../C++/Settings.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/Settings.o ../../C++/Settings.cpp

${OBJECTDIR}/_ext/56246743/SparkStatus.o: ../../C++/SparkStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/SparkStatus.o ../../C++/SparkStatus.cpp

${OBJECTDIR}/_ext/56246743/utils.o: ../../C++/utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/56246743
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56246743/utils.o ../../C++/utils.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../C++/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
