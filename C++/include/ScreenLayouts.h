...
#define	READY_LOADED_LINE1          Center,     64,     32,     1, 	0xFFFF,     "Ready"
#define	READY_LOADED_LINE2          Center,     64,     48,     1, 	0xFFFF,     "Load your prepped"
#define	READY_LOADED_LINE3          Center,     64,     64,     1, 	0xFFFF,     "print file through"
#define	READY_LOADED_LINE4          Center,     64,     80,     1, 	0xFFFF,     "Spark or via USB."
#define	READY_LOADED_BTN1_LINE1     Left,       0,      100,    1, 	0xFFFF,     "Reprint"
#define	READY_LOADED_BTN1_LINE2     Left,       0,      112,    1, 	0xFFFF,     "file"
#define	READY_LOADED_BTN2_LINE1     Right,      127,    100,    1, 	0xFFFF,     "Clear"
...
#define	START_LOADED_LINE5          Center,     64,     80,     1, 	0xFFFF,     "If yes, press Start." 
...
#define	LOAD_FAIL_LINE1             Center,     64,     48,     1, 	0xFFFF,     "Error"
#define	LOAD_FAIL_LINE2             Center,     64,     64,     1, 	0xFFFF,     "loading file."
#define	LOAD_FAIL_BTN1_LINE2        Left,       0,      112,    1, 	0xFFFF,     "Try again"
#define	LOAD_FAIL_BTN2_LINE2        Right,      127,    112,    1, 	0xFFFF,     "Cancel"
...
#define	CANCELPROMPT_LINE1          Center,     64,     48,     1, 	0xFFFF,     "Cancel"
#define	CANCELPROMPT_LINE2          Center,     64,     64,     1, 	0xFFFF,     "print?"
...
#define	PRINT_COMPLETE_BTN1_LINE2   Right,      127,    112,    1, 	0xFFFF,     "Home"
#define	PRINT_COMPLETE_LED_SEQ  6

#define STARTING_PRINT_LINE1        Center,     64,     64,     1,  0xFFFF,     "Starting print..."
#define STARTING_PRINT_BTN2_LINE2   Right,      127,    112,    1,  0xFFFF,     "Cancel"
#define STARTING_PRINT_LED_SEQ   0

#define LOAD_FIRST_LINE1            Center,     64,     32,     1,  0xFFFF,     "Ready."
#define LOAD_FIRST_LINE2            Center,     64,     48,     1,  0xFFFF,     "Load your prepped"
#define LOAD_FIRST_LINE3            Center,     64,     64,     1,  0xFFFF,     "file through Spark"
#define LOAD_FIRST_LINE4            Center,     64,     80,     1,  0xFFFF,     "or via USB." 
#define LOAD_FIRST_LED_SEQ    0

#define LOADING_FILE_LINE1          Center,     64,     64,     1,  0xFFFF,     "Loading file..."
#define LOADING_FILE_BTN2_LINE2     Right,      127,    112,    1,  0xFFFF,     "Cancel"
...
#define	CANCELED_BTN2_LINE2         Right,      127,    112,    1, 	0xFFFF,     "Home"
#define	CANCELED_LED_SEQ      7
 
#define	DOOR_OPEN_LINE1             Center,     64,     16,     1, 	0xFFFF,     "Door open."
#define	DOOR_OPEN_LINE2             Center,     64,     32,     1, 	0xFFFF,     "Please close the"
#define	DOOR_OPEN_LINE3             Center,     64,     48,     1, 	0xFFFF,     "door ASAP to avoid"
#define	DOOR_OPEN_LINE4             Center,     64,     64,     1, 	0xFFFF,     "exposing the photo-"
...
#define ERROR_CODE_BTN2_LINE2       Left,       0,      112,    1,  0xFFFF,     "Reset"
#define	ERROR_CODE_LED_SEQ  4

#define	ERROR_DURING_PRINT_LINE1    Center,     64,     16,     1, 	0xFFFF,     "An error occurred"
#define	ERROR_DURING_PRINT_LINE2    Center,     64,     32,     1, 	0xFFFF,     "while printing."
#define	ERROR_DURING_PRINT_LINE3    Center,     64,     48,     1, 	0xFFFF,     "Confirm the build"
#define	ERROR_DURING_PRINT_LINE4    Center,     64,     64,     1, 	0xFFFF,     "area is clear before"
#define	ERROR_DURING_PRINT_LINE5    Center,     64,     80,     1, 	0xFFFF,     "proceeding."
#define	ERROR_DURING_PRINT_BTN1_LINE2 Right,    127,    112,    1, 	0xFFFF,     "Home"
#define	ERROR_DURING_PRINT_LED_SEQ    4

#define	HOMING_LINE1                Center,     64,     48,     1, 	0xFFFF,     "Homing the build"
#define	HOMING_LINE2                Center,     64,     64,     1, 	0xFFFF,     "platform. Please wait..."
