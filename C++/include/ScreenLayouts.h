...
#define USB_FILE_FOUND_LINE2        Center,      64,    32,     1,  0xFFFF,     "%s" 
#define USB_FILE_FOUND_LINE3        Center,      64,    48,     1,  0xFFFF,     "%s"
#define USB_FILE_FOUND_LINE4        Center,      64,    64,     1,  0xFFFF,     "%s"
#define USB_FILE_FOUND_LINE5        Center,      64,    80,     1,  0xFFFF,     "?"
