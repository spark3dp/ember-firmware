...
${OBJECTDIR}/I2C_Bus.o: I2C_Bus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/I2C_Bus.o I2C_Bus.cpp
...
${OBJECTDIR}/I2C_Bus_nomain.o: ${OBJECTDIR}/I2C_Bus.o I2C_Bus.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/I2C_Bus_nomain.o I2C_Bus.cpp;\
	else  \
