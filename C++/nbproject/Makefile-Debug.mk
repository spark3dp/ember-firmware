...
${OBJECTDIR}/LayerSettings.o: LayerSettings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LayerSettings.o LayerSettings.cpp
...
${OBJECTDIR}/MotorCommand.o: MotorCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotorCommand.o MotorCommand.cpp
...
${OBJECTDIR}/PrintDataDirectory.o: PrintDataDirectory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintDataDirectory.o PrintDataDirectory.cpp

${OBJECTDIR}/PrintDataZip.o: PrintDataZip.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintDataZip.o PrintDataZip.cpp
...
${OBJECTDIR}/PrinterStatus.o: PrinterStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrinterStatus.o PrinterStatus.cpp
...
${OBJECTDIR}/SparkStatus.o: SparkStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SparkStatus.o SparkStatus.cpp

${OBJECTDIR}/TarGzFile.o: TarGzFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TarGzFile.o TarGzFile.cpp
...
${OBJECTDIR}/Thermometer.o: Thermometer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Thermometer.o Thermometer.cpp
...
${TESTDIR}/tests/FrontPanelTest.o: tests/FrontPanelTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -I. -include tests/support/FileUtils.hpp -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FrontPanelTest.o tests/FrontPanelTest.cpp


${TESTDIR}/tests/LayerSettingsUT.o: tests/LayerSettingsUT.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -I. -include tests/support/FileUtils.hpp -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/LayerSettingsUT.o tests/LayerSettingsUT.cpp
...
${TESTDIR}/tests/PrintDataDirectoryUT.o: tests/PrintDataDirectoryUT.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -I. -include tests/support/FileUtils.hpp -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PrintDataDirectoryUT.o tests/PrintDataDirectoryUT.cpp
...
${TESTDIR}/tests/PrintDataZipUT.o: tests/PrintDataZipUT.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -I. -I. -include tests/support/FileUtils.hpp -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PrintDataZipUT.o tests/PrintDataZipUT.cpp
...
${TESTDIR}/tests/PE_PD_IT.o: tests/PE_PD_IT.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -I. -include tests/support/FileUtils.hpp -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PE_PD_IT.o tests/PE_PD_IT.cpp
...
${TESTDIR}/tests/ScreenUT.o: tests/ScreenUT.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -Iinclude -I. -include tests/support/FileUtils.hpp -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ScreenUT.o tests/ScreenUT.cpp
...
${OBJECTDIR}/LayerSettings_nomain.o: ${OBJECTDIR}/LayerSettings.o LayerSettings.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LayerSettings_nomain.o LayerSettings.cpp;\
	else  \
...
${OBJECTDIR}/MotorCommand_nomain.o: ${OBJECTDIR}/MotorCommand.o MotorCommand.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotorCommand_nomain.o MotorCommand.cpp;\
	else  \
...
${OBJECTDIR}/PrintDataDirectory_nomain.o: ${OBJECTDIR}/PrintDataDirectory.o PrintDataDirectory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintDataDirectory_nomain.o PrintDataDirectory.cpp;\
	else  \
...
${OBJECTDIR}/PrintDataZip_nomain.o: ${OBJECTDIR}/PrintDataZip.o PrintDataZip.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrintDataZip_nomain.o PrintDataZip.cpp;\
	else  \
...
${OBJECTDIR}/PrinterStatus_nomain.o: ${OBJECTDIR}/PrinterStatus.o PrinterStatus.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrinterStatus_nomain.o PrinterStatus.cpp;\
	else  \
...
${OBJECTDIR}/SparkStatus_nomain.o: ${OBJECTDIR}/SparkStatus.o SparkStatus.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SparkStatus_nomain.o SparkStatus.cpp;\
	else  \
...
${OBJECTDIR}/TarGzFile_nomain.o: ${OBJECTDIR}/TarGzFile.o TarGzFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TarGzFile_nomain.o TarGzFile.cpp;\
	else  \
...
${OBJECTDIR}/Thermometer_nomain.o: ${OBJECTDIR}/Thermometer.o Thermometer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Thermometer_nomain.o Thermometer.cpp;\
	else  \
