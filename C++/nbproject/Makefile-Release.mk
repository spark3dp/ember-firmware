...
${OBJECTDIR}/ImageProcessor.o: ImageProcessor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -I/usr/include/ImageMagick -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageProcessor.o ImageProcessor.cpp
...
${OBJECTDIR}/ImageProcessor_nomain.o: ${OBJECTDIR}/ImageProcessor.o ImageProcessor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -I/usr/include/ImageMagick -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageProcessor_nomain.o ImageProcessor.cpp;\
	else  \
