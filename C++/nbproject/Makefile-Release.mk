...
${OBJECTDIR}/HardwareTimeout.o: HardwareTimeout.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -I/usr/include/ImageMagick -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareTimeout.o HardwareTimeout.cpp
...
${OBJECTDIR}/HardwareTimeout_nomain.o: ${OBJECTDIR}/HardwareTimeout.o HardwareTimeout.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -I/usr/include/ImageMagick -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HardwareTimeout_nomain.o HardwareTimeout.cpp;\
	else  \
