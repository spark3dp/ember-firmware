...
module Tests
  describe 'firmware' do
    ...
    scenario 'cancel when moving to start position' do
      ...
      expect(front_panel).to show_text({ text: 'Starting to print',            x_position: 64,  y_position: 32,  alignment: :center, color: 0xFFFF, size: 1},
                                       ...
                                       { text: 'Cancel',                       x_position: 0,   y_position: 80,  alignment: :left,   color: 0xFFFF, size: 1},
      ...
      #press cancel button
      front_panel.button_action(BTN1_PRESS)

      expect(motor_controller).to be_paused
      expect(motor_controller).to be_cleared
    ...
    scenario 'cancel after arriving at start position' do
